...
from Modules.database import (
    ...
    criar_usuario, buscar_usuario_por_username
)
from Modules.analise import (
...
# (Opcional) Criar usuário admin se não existir – descomente na primeira execução
# if not buscar_usuario_por_username("admin"):
#     criar_usuario("admin", "Administrador", "1234")
#     st.success("Usuário admin criado com senha 1234")# ============================================
